  ...
  return (
    <ScrollView style={styles.container}>
      <View style={styles.header}>
        <Image source={require('../../assets/images/logo.png')} style={styles.menuIcon} resizeMode="contain" />
        <Text style={styles.welcomeText}>HOŞ GELDIŇIZ {profile?.username || 'Myhman'}</Text>
      </View>

      <View style={styles.profileCard}>
        <View style={{ alignItems: 'center' }}>
          <Image source={{ uri: 'https://via.placeholder.com/150x50?text=LOGO' }} style={styles.logo} resizeMode="contain" />
      ...
      <Modal visible={isEditing} animationType="fade" transparent={true}>
        <View style={styles.modalContainer}>
          <View style={styles.modalContent}>
            <Text style={styles.modalTitle}>Profili redaktirlemek</Text>
            ...
            <View style={styles.modalButtonContainer}>
              ...
              <TouchableOpacity
                style={[styles.modalButton, { backgroundColor: COLORS.TEXT, marginLeft: 10 }]}
      ...
      {/* PAROL MODALY */}
      <Modal visible={isChangingPassword} animationType="fade" transparent={true}>
        <View style={styles.modalContainer}>
          <View style={styles.modalContent}>
      ...
      <Modal visible={isAvatarModalVisible} transparent={true} animationType="fade">
        <View style={styles.modalContainer}>
          <View style={styles.modalContent}>
            ...
            <TouchableOpacity
              style={[styles.avatarModalButton, { backgroundColor: COLORS.TEXT }]}
...
const styles = StyleSheet.create({
  ...
  retryButton: { backgroundColor: COLORS.ACCENT, borderRadius: 30, padding: 12, marginTop: 15 },
});